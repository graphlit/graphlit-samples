...
st.markdown("Chat with uploaded files.  Text extraction and OCR done with [Azure AI Document Intelligence](https://azure.microsoft.com/en-us/products/ai-services/ai-document-intelligence).  Chat completion uses the [OpenAI GPT-4 Turbo 128k](https://platform.openai.com/docs/models/gpt-4-and-gpt-4-turbo) LLM.")
...
with st.form("data_content_form"):    
    if file_types:
        ...
        if submit_content and uploaded_files:
                ...
                with uploaded_files_status.expander("Uploaded Files", expanded=True):
                    ...
                    for file in uploaded_files:
                        ...
                        with st.spinner('Ingesting file... Please wait.'):
                            error_message = ingest_file(file.name, file.type, base64_content)
